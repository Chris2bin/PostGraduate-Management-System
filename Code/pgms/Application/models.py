...
class Apply(models.Model):
    ...
    app_admin = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='admin', verbose_name="Approving Admin", null=True)
    app_student = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='student', verbose_name="Student", null=True)
    def __str__(self):
